...
class Montfort_Widget_8_Footer extends \Elementor\Widget_Base {

	public function get_name() {
		return 'montfort-footer';
	}

	public function get_title() {
		return esc_html__( '8-Footer', 'montfort' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Footer Content', 'montfort' ),
			]
		);
		...
		$this->add_control(
			'footer_id',
			[
				'label' => esc_html__( 'Footer ID', 'montfort' ),
		...
		$office_repeater = new \Elementor\Repeater();
		$office_repeater->add_control(
			'city',
			[
				'label' => esc_html__( 'City', 'montfort' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => 'City',
			]
		);
		$office_repeater->add_control(
			'address',
			[
				'label' => esc_html__( 'Address', 'montfort' ),
		...
		$office_repeater->add_control(
			'phone',
			[
				'label' => esc_html__( 'Phone', 'montfort' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => 'Phone',
			]
		);
		$office_repeater->add_control(
			'phone_url',
			[
				'label' => esc_html__( 'Phone URL', 'montfort' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => 'tel:+000',
			]
		);
		$office_repeater->add_control(
			'email',
			[
				'label' => esc_html__( 'Email', 'montfort' ),
				'type' => \Elementor\Controls_Manager::TEXT,
		...
		$office_repeater->add_control(
			'email_url',
			[
				'label' => esc_html__( 'Email URL', 'montfort' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => 'mailto:email@example.com',
			]
		);
		...
		$this->add_control(
			'offices',
			[
				'label' => esc_html__( 'Offices', 'montfort' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $office_repeater->get_controls(),
				'default' => [
					[
						'city' => 'Geneva, Switzerland',
						'address' => "3rd & 4th floor\nRue du Mont-Blanc 14\n1201 Geneva, Switzerland",
						'phone' => 'P : +41 227415900',
						'phone_url' => 'tel:+41227415900/',
						'email' => 'gva.reception@mont-fort.com',
						'email_url' => 'mailto:gva.reception@mont-fort.com/',
					],
					[
						'city' => 'Dubai, UAE',
						'address' => "1104 ICD Brookfield Place\nDubai International Financial Centre\nDubai, United Arab Emirates",
						'phone' => 'P : +971 45914032',
						'phone_url' => 'tel:+97145914032/',
						'email' => 'uae.reception@mont-fort.com',
						'email_url' => 'mailto:uae.reception@mont-fort.com/',
					],
					[
						'city' => 'Singapore',
						'address' => "0804 Marina One East Tower\n7 Straits View\n018936, Singapore",
						'phone' => 'P : +65 3105 1583',
						'phone_url' => 'tel:+6531051583/',
						'email' => 'sing.reception@mont-fort.com',
						'email_url' => 'mailto:sing.reception@mont-fort.com/',
					],
				],
				'title_field' => '{{{ city }}}',
			]
		...
		$this->add_control(
			'copyright_text',
			[
				'label' => esc_html__( 'Copyright Text', 'montfort' ),
				'type' => \Elementor\Controls_Manager::TEXT,
	...
	protected function render() {
		...
		?>
		<footer data-astro-transition-persist="footer" id="<?php echo esc_attr( $settings['footer_id'] ); ?>" data-theme="light" data-astro-cid-rhv6ztfp="">
			<div class="grid footer-container" data-astro-cid-rhv6ztfp="">
					...
					<ul class="menu-links" data-astro-cid-rhv6ztfp="">
						<?php foreach ( $settings['menu_links'] as $link ) : ?>
							<li data-astro-cid-rhv6ztfp="">
								<a href="<?php echo esc_url( $link['link_url']['url'] ); ?>" class="fs-cta-s uppercase" data-astro-cid-rhv6ztfp="true"><?php echo esc_html( $link['link_text'] ); ?></a>
							</li>
						<?php endforeach; ?>
					</ul>
				...
				<div class="menu-right dk:col-start-3 ml:col-start-10 ml:col-end-24 lg:col-start-11 lg:col-end-21" data-astro-cid-rhv6ztfp="">
					<?php foreach ( $settings['offices'] as $office ) : ?>
						<div class="office no-image" data-theme="light" data-astro-cid-spfovdek="">
							<div class="top" data-astro-cid-spfovdek="">
								<h2 class="fs-s2 uppercase" data-astro-cid-spfovdek=""><?php echo esc_html( $office['city'] ); ?></h2>
								<p class="fs-body-s address" data-astro-cid-spfovdek="">
									<?php echo nl2br( esc_html( $office['address'] ) ); ?>
								</p>
							</div>
							<div class="bottom" data-astro-cid-spfovdek="">
								<a href="<?php echo esc_attr( $office['phone_url'] ); ?>" class="fs-body-s" data-astro-cid-spfovdek="true"><?php echo esc_html( $office['phone'] ); ?></a>
								<a href="<?php echo esc_attr( $office['email_url'] ); ?>" class="fs-body-s" data-astro-cid-spfovdek="true"><?php echo esc_html( $office['email'] ); ?></a>
							</div>
						</div>
					<?php endforeach; ?>
				</div>
				...
				<div class="copyright-info dk:col-start-3 dk:col-end-24 ml:col-start-10 ml:col-end-24 lg:col-start-11 lg:col-end-21" data-astro-cid-rhv6ztfp="">
					<p class="fs-body-s montfort-navy-blue" data-astro-cid-rhv6ztfp=""><?php echo esc_html( $settings['copyright_text'] ); ?></p>
				</div>
			</div>
		</footer>
