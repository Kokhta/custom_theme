...
class Footer_Widget extends Widget_Base {
	...
	protected function register_controls() {
		...
		$link_repeater->add_control( 'text', array( 'label' => 'Text', 'type' => Controls_Manager::TEXT ) );
		$link_repeater->add_control( 'url', array( 'label' => 'URL', 'type' => Controls_Manager::URL ) );
		...
		$office_repeater = new Repeater();
		$office_repeater->add_control( 'city', array( 'label' => 'City', 'type' => Controls_Manager::TEXT ) );
		$office_repeater->add_control( 'address', array( 'label' => 'Address', 'type' => Controls_Manager::TEXTAREA ) );
		$office_repeater->add_control( 'phone', array( 'label' => 'Phone', 'type' => Controls_Manager::TEXT ) );
		$office_repeater->add_control( 'email', array( 'label' => 'Email', 'type' => Controls_Manager::TEXT ) );
					...
					<ul class="menu-links" data-astro-cid-rhv6ztfp="">
						<?php foreach ( $settings['menu_links'] as $link ) : ?>
							<li data-astro-cid-rhv6ztfp="">
								<a href="<?php echo esc_url( $link['url']['url'] ); ?>" class="fs-cta-s uppercase" data-astro-cid-rhv6ztfp="true"><?php echo esc_html( $link['text'] ); ?></a>
							</li>
						<?php endforeach; ?>
					</ul>
					...
					<?php foreach ( $settings['offices'] as $office ) : ?>
						<div class="office no-image" data-theme="light" data-astro-cid-spfovdek="">
							...
							<div class="bottom" data-astro-cid-spfovdek="">
								<?php if ( $office['phone'] ) : ?>
									<a href="tel:<?php echo esc_attr( $office['phone'] ); ?>/" class="fs-body-s" data-astro-cid-spfovdek="true">P : <?php echo esc_html( $office['phone'] ); ?></a>
								<?php endif; ?>
								<?php if ( $office['email'] ) : ?>
