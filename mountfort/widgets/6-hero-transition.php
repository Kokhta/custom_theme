...
class MountFort_Widget_6_Hero_Transition extends \Elementor\Widget_Base {

	public function get_name() {
		return 'mountfort_hero_transition';
	}

	public function get_title() {
		return esc_html__( '6-Hero Transition', 'mountfort' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control( 'title', [ 'type' => \Elementor\Controls_Manager::TEXT, 'default' => 'Title' ] );

		$this->add_control(
			'titles',
			[
				'label' => esc_html__( 'Titles', 'mountfort' ),
		...
		<div class="hero-transition" data-astro-transition-persist="transition-hero" data-cursor="draggable" data-cursor-down="dragging" data-astro-cid-3rse3tms="" style="--slide-progress: 0; opacity: 0;">
			<div class="inner" data-astro-cid-3rse3tms="">
				<?php foreach ( $settings['titles'] as $index => $item ) : ?>
					<div class="title" data-astro-cid-3rse3tms="" style="opacity: <?php echo $index === 0 ? '1' : '0.5'; ?>;">
