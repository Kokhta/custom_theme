...
class MountFort_Widget_16_Footer extends \Elementor\Widget_Base {

	public function get_name() {
		return 'mountfort_footer';
	}

	public function get_title() {
		return esc_html__( '16-Footer', 'mountfort' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'legals_links',
			[
				'label' => esc_html__( 'Legals Links', 'mountfort' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
		...
		$office_repeater->add_control( 'city', [ 'type' => \Elementor\Controls_Manager::TEXT ] );
		$office_repeater->add_control( 'address', [ 'type' => \Elementor\Controls_Manager::TEXTAREA ] );
		$office_repeater->add_control( 'phone', [ 'type' => \Elementor\Controls_Manager::TEXT ] );
		$office_repeater->add_control( 'phone_url', [ 'type' => \Elementor\Controls_Manager::TEXT ] );
		$office_repeater->add_control( 'email', [ 'type' => \Elementor\Controls_Manager::TEXT ] );

		$this->add_control(
			'offices',
			[
				'label' => esc_html__( 'Offices', 'mountfort' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $office_repeater->get_controls(),
				'default' => [
					[ 'city' => 'Geneva, Switzerland', 'address' => "3rd & 4th floor\nRue du Mont-Blanc 14\n1201 Geneva, Switzerland", 'phone' => 'P : +41 227415900', 'phone_url' => '+41227415900', 'email' => 'gva.reception@mont-fort.com' ],
					[ 'city' => 'Dubai, UAE', 'address' => "1104 ICD Brookfield Place\nDubai International Financial Centre\nDubai, United Arab Emirates", 'phone' => 'P : +971 45914032', 'phone_url' => '+97145914032', 'email' => 'uae.reception@mont-fort.com' ],
					[ 'city' => 'Singapore', 'address' => "0804 Marina One East Tower\n7 Straits View\n018936, Singapore", 'phone' => 'P : +65 3105 1583', 'phone_url' => '+6531051583', 'email' => 'sing.reception@mont-fort.com' ],
				],
			]
		);
		...
		$this->add_control(
			'copyright',
			[
				'label' => esc_html__( 'Copyright Text', 'mountfort' ),
			...
			<div class="grid footer-container" data-astro-cid-rhv6ztfp="">
				<div class="menu-left dk:col-start-3 dk:col-end-10 ml:col-start-3 ml:col-end-9 lg:col-start-4 lg:col-end-10" data-astro-cid-rhv6ztfp="">
					...
					<ul class="legals-links" data-astro-cid-rhv6ztfp="">
						<?php foreach ( $settings['legals_links'] as $link ) : ?>
							<li data-astro-cid-rhv6ztfp="">
								<a href="<?php echo esc_url($link['link_url']['url']); ?>" class="fs-cta-s uppercase" data-astro-cid-rhv6ztfp="true"><?php echo esc_html($link['link_text']); ?></a>
							</li>
						<?php endforeach; ?>
					...
					<?php foreach ( $settings['offices'] as $office ) : ?>
						<div class="office no-image" data-theme="light" data-astro-cid-spfovdek="">
							<div class="top" data-astro-cid-spfovdek="">
								...
								<p class="fs-body-s address" data-astro-cid-spfovdek=""> <?php echo nl2br(esc_html($office['address'])); ?> </p>
							</div>
							<div class="bottom" data-astro-cid-spfovdek="">
								<a href="tel:<?php echo esc_attr($office['phone_url']); ?>/" class="fs-body-s" data-astro-cid-spfovdek="true"><?php echo esc_html($office['phone']); ?></a>
								<a href="mailto:<?php echo esc_attr($office['email']); ?>/" class="fs-body-s" data-astro-cid-spfovdek="true"><?php echo esc_html($office['email']); ?></a>
							</div>
						</div>
					<?php endforeach; ?>
				</div>
				...
				<div class="legal-info-container dk:col-start-3 dk:col-end-10 ml:col-start-3 ml:col-end-9 lg:col-start-4 lg:col-end-10" data-astro-cid-rhv6ztfp="">
					<!-- Logo svg - keeping as is for fidelity -->
