<!DOCTYPE html>
<html <?php language_attributes(); ?> data-astro-transition-scope="astro-smooz4hq-1" class="lenis lenis-scrolling lenis-smooth" style="--vw: 4.14px; --dvh: 8.46px; --svh: 8.46px;">
<head>
	...
	<meta name="description" content="We are a global commodity trading company and asset investment company that trade in physical commodity, small commodity, downstream oil in UAE, Singapore, Switzerland.">
	<meta property="og:description" content="We are a global commodity trading company and asset investment company that trade in physical commodity, small commodity, downstream oil in UAE, Singapore, Switzerland.">
	<meta name="keywords" content="keyword 2, keyword 2">
	<meta property="og:title" content="Montfort Group">
	...
	<script type="module" src="/_astro/ClientRouter.astro_astro_type_script_index_0_lang.WONxKOw9.js" data-astro-exec=""></script>
	...
	<style data-savepage-fontface="">@font-face { font-family: Century Gothic; src: url('/assets/fonts/CenturyGothic.woff2'); font-weight: 400;  }</style>
	<style data-savepage-fontface="">@font-face { font-family: Century Gothic; src: url('/assets/fonts/CenturyGothic-Bold.woff2'); font-weight: 700;  }</style>
	<style data-savepage-fontface="">@font-face { font-family: Josefin Sans; src: url('/assets/fonts/JosefinSans-Light.woff2'); font-weight: 300;  }</style>
	<link rel="modulepreload" as="script" crossorigin="" href="/_astro/KTX2Loader.DxCkVlRj.js">
	<link rel="modulepreload" as="script" crossorigin="" href="/_astro/index.Brfk6Bdo.js">
	<link rel="modulepreload" as="script" crossorigin="" href="/_astro/ScrollTrigger.6qCihK2t.js">
	<link rel="modulepreload" as="script" crossorigin="" href="/_astro/router.B-sij-_X.js">
	<link rel="modulepreload" as="script" crossorigin="" href="/_astro/visitedNews.BmN7K1ri.js">
</head>
