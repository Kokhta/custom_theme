...
class Widget_9_Aftercare extends \Elementor\Widget_Base {
	...
	public function get_title() { return '9-Aftercare'; }
	...
	protected function register_controls() {
		...
		$this->add_control('description', ['label' => 'Description', 'type' => \Elementor\Controls_Manager::TEXTAREA, 'default' => 'Kriss.ai understands the importance...']);
		...
		$this->add_control('productFeatures', [
			...
			'default' => [
				[
                    'f_title' => '24/7 Post Treatment Support',
                    'f_desc' => 'Kriss is accessible 24/7...',
                    'f_icon' => '/media/R7_24-7 Post-Treatment-Support-1.png',
                    'messages' => [
                        ['role'=>'user', 'name'=>'John Smith', 'text'=>'I just got veneers...'],
                        ['role'=>'krissai', 'name'=>'Sally Smith', 'text'=>'Congratulations...']
                    ]
                ],
			],
			'title_field' => '{{{ f_title }}}',
