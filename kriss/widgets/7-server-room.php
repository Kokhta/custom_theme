...
class Widget_7_Server_Room extends \Elementor\Widget_Base {
	...
	public function get_title() { return '7-Server Room'; }
	...
	protected function register_controls() {
		...
		$this->add_control('productFeatures', [
			...
			'default' => [
				[
                    'f_title' => 'Large Language Models ',
                    'f_desc' => 'LLM-powered chatbots process large volumes of data...',
                    'f_icon' => '/media/R5_Natural-Language-Processing-(NLP)-1.png',
                    'messages' => [
                        ['role'=>'krissai', 'name'=>'Sally Smith', 'text'=>'Kriss.ai leverages advanced language models...']
                    ]
                ],
			],
			'title_field' => '{{{ f_title }}}',
