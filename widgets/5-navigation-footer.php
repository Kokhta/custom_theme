...
class Custom_Widget_5_Navigation_Footer extends Widget_Base {

	public function get_name() {
		return '5-navigation-footer';
	}

	public function get_title() {
		return esc_html__( '5-Navigation & Footer', 'custom-hello-theme' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'nav_section',
			[
				'label' => esc_html__( 'Chapters', 'custom-hello-theme' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);

		$repeater = new Repeater();
		$repeater->add_control( 'key', [ 'type' => Controls_Manager::TEXT, 'label' => 'Key' ] );
		...
		$this->add_control( 'chapters', [
			...
			'default' => [
				...
				[ 'key' => 'GlobalConnectivity', 'label' => 'Global connectivity' ],
        ...
        $this->start_controls_section(
			'footer_section',
			[
				'label' => esc_html__( 'Footer Offices', 'custom-hello-theme' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);

        $off_repeater = new Repeater();
        $off_repeater->add_control( 'city', [ 'type' => Controls_Manager::TEXT, 'label' => 'City' ] );
        $off_repeater->add_control( 'addr', [ 'type' => Controls_Manager::TEXTAREA, 'label' => 'Address' ] );
        $off_repeater->add_control( 'tel', [ 'type' => Controls_Manager::TEXT, 'label' => 'Phone' ] );
        $off_repeater->add_control( 'email', [ 'type' => Controls_Manager::TEXT, 'label' => 'Email' ] );

        $this->add_control( 'offices', [
            'label' => 'Offices',
            'type' => Controls_Manager::REPEATER,
            'fields' => $off_repeater->get_controls(),
            'default' => [
				[ 'city' => 'Geneva, Switzerland', 'addr' => "3rd & 4th floor\nRue du Mont-Blanc 14\n1201 Geneva, Switzerland", 'tel' => '+41 227415900', 'email' => 'info@montfortgroup.com' ],
				[ 'city' => 'Dubai, UAE', 'addr' => "1104 ICD Brookfield Place\nDubai International Financial Centre\nDubai, United Arab Emirates", 'tel' => '+971 45914032', 'email' => 'info@montfortgroup.com' ],
				[ 'city' => 'Singapore', 'addr' => "0804 Marina One East Tower\n7 Straits View\n018936, Singapore", 'tel' => '+65 3105 1583', 'email' => 'info@montfortgroup.com' ],
			],
            'title_field' => '{{{ city }}}',
        ] );
					...
					<?php foreach ( $settings['chapters'] as $item ) : ?>
						<div class="chapter-wrapper" data-chapter-key="<?php echo esc_attr( $item['key'] ); ?>" data-astro-cid-gpzihxjt>
							<div class="progress-wrapper" data-astro-cid-gpzihxjt>
								<div class="progress-bar white-part" data-astro-cid-gpzihxjt></div>
								<div class="progress-bar blue-part" data-astro-cid-gpzihxjt></div>
							</div>
							<a class="chapter-link" href="#<?php echo esc_attr( $item['key'] ); ?>" data-astro-cid-gpzihxjt="true">
								<div class="dot" data-astro-cid-gpzihxjt> <span data-astro-cid-gpzihxjt></span> </div>
								<div class="text-container" data-astro-cid-gpzihxjt> <span data-astro-cid-gpzihxjt><?php echo esc_html( $item['label'] ); ?></span> </div>
							</a>
						</div>
					<?php endforeach; ?>
					<div class="chapter-wrapper" data-astro-cid-gpzihxjt> <div class="dot" data-astro-cid-gpzihxjt> <span data-astro-cid-gpzihxjt></span> </div> </div>
				</nav>
			</div>
		</div>
        </main>
        ...
        <footer data-astro-transition-persist="footer" id="footer" data-theme="light" data-astro-cid-rhv6ztfp>
			<div class="grid footer-container" data-astro-cid-rhv6ztfp>
				...
				<div class="copyright-info dk:col-start-3 dk:col-end-24 ml:col-start-10 ml:col-end-24 lg:col-start-11 lg:col-end-21" data-astro-cid-rhv6ztfp>
					<p class="fs-body-s montfort-navy-blue" data-astro-cid-rhv6ztfp>© 2021 | Montfort - All rights reserved</p>
				</div>
			</div>
		</footer>
		<?php
